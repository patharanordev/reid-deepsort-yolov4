# **ReID datasets on DeepSORT with YOLOv4**

[![license](https://img.shields.io/github/license/mashape/apistatus.svg)](LICENSE)
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1JM_dEhSXbStlk1EETfxl4IG2YxKqgAPG?usp=sharing)
...
## **Requirements**
 ...
 - Python3
 - pip version > 19.0
 - YOLOv4's weight - It's available in `./data/yolov4-tiny.weights` directory for tiny.
...
In this example using `pip` command in Python environment :
